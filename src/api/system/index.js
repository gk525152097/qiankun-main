const menuList = [
  { id: 1, parentId: 0, name: '角色管理', rang: 4, icon: 'el-icon-user-solid', path: '/roleManage', component: 'views/roleManage', hidden: false, redirect: '' },
  ...
  { id: 6, parentId: 0, name: '用户管理', rang: 6, icon: 'el-icon-user', path: '/userManage', component: 'views/roleManage', hidden: false, redirect: '' },
  { id: 7, parentId: 0, name: '应用管理', rang: 0, icon: 'el-icon-help', path: '/childAppManage', component: 'views/childAppManage', hidden: false, redirect: '' },
  { id: 8, parentId: 0, name: '一级试菜单', rang: 8, icon: 'el-icon-help', path: '/testPage1', component: 'views/roleManage', hidden: false, redirect: '' },
  { id: 9, parentId: 8, name: '二级试菜单', rang: 9, icon: '', path: '/testPage2', component: 'views/roleManage', hidden: false, redirect: '' },
  { id: 10, parentId: 9, name: '三级级菜单', rang: 10, icon: '', path: '/testPage3', component: 'views/roleManage', hidden: false, redirect: '' }
]
